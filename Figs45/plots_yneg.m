...
%
load('../data/walks/linear/yneg/w0.001+1.01i_L6_N500.mat');
figure(6);
hold on
...
zlabel('imag(chi)')
%
load('../data/walks/linear/yneg/w1+0.001i_L6_N500.mat');
figure(6);
hold on
...
%
load('../data/walks/linear/yneg/w-0.001+1.01i_L6_N500.mat');
...
%
load('../data/walks/linear/yneg/w-1+0.001i_L6_N500.mat');
