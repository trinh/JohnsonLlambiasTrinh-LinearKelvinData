...
%%
load('../data/walks/linear/neg/w0.001+1.01i_L6_N4000.mat');
figure(6);
hold on
...
%%
load('../data/walks/linear/neg/w0.001-1.01i_L6_N1000.mat');
figure(6);
hold on
...
zlabel('imag(chi)')
%%
load('../data/walks/linear/neg/w1+0.001i_L6_N1000.mat');
figure(6);
hold on
...
%%
load('../data/walks/linear/neg/w-0.001+1.01i_L6_N1000.mat');
...
%%
load('../data/walks/linear/neg/w-0.001-1.01i_L6_N250.mat');
figure(6);
hold on
...
%%
load('../data/walks/linear/neg/w-1+0.001i_L6_N250.mat');
